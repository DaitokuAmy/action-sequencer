...
namespace ActionSequencer.Editor {
    ...
    public abstract class SequenceEventView : VisualElement {
        ...
        public Subject<ContextualMenuPopulateEvent> OpenContextMenuSubject { get; } =
            new Subject<ContextualMenuPopulateEvent>();
        ...
        public SequenceEventView(bool resizable) {
            ...
            _contextualMenuManipulator.activators.Add(new ManipulatorActivationFilter
                { button = MouseButton.RightMouse, modifiers = EventModifiers.Command });
            _contextualMenuManipulator.activators.Add(new ManipulatorActivationFilter
                { button = MouseButton.RightMouse, modifiers = EventModifiers.Control });
