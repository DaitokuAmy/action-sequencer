...
namespace ActionSequencer.Editor.VisualElements {
    ...
    public sealed partial class AnimationClipView : VisualElement {
        ...
        private sealed class AnimationClipEditor : IDisposable {
            ...
            /// <summary>現在の対象オブジェクト</summary>
            public Object Target => _editor != null ? _editor.target : null;
            /// <summary>生成済み Editor</summary>
        ...
        /// <summary>有効なプレビュー対象を持つかどうか</summary>
